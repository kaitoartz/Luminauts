...
const WaitlistLanding = ({ onNavigate, theme, isLoading, isSplashActive, games = [] }) => {
  ...
  return (
    <div className={`min-h-screen w-full max-w-full bg-zinc-950 text-white transition-all duration-700 relative ${isLoading ? 'blur-md opacity-40 pointer-events-none' : 'blur-none opacity-100'}`}>
