...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    const docHeight = document.documentElement.scrollHeight - window.innerHeight;
    const progress = docHeight > 0 ? scrollY / docHeight : 0;
    const currentCenterY = centerY - progress * scrollSpeed;
    ...
    u.uCenterOffset.value   = new Float32Array([centerX, currentCenterY]);
    u.uZoom.value           = zoom;
    ...
    centerX, centerY, zoom, color1, color2, color3, scrollSpeed
  ]);
