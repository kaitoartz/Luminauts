...
export default function FeatureSection({ onNavigate }) {
  ...
  return (
    <section className="relative max-w-6xl mx-auto my-16 lg:my-32 p-6 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-6 min-h-128 border border-zinc-200/60 dark:border-zinc-800/30 bg-white/80 dark:bg-zinc-900/30 backdrop-blur-md overflow-hidden rounded-4xl shadow-xl shadow-zinc-100 dark:shadow-none transition-all duration-300">
      ...
      <div className="w-full lg:w-1/2 z-10 flex flex-col items-center lg:items-start text-center lg:text-left">
        ...
        <h2 className="font-display text-4xl sm:text-5xl lg:text-6xl font-black mb-6 text-zinc-900 dark:text-white tracking-tight leading-[1.15]">
          Alinea tu mente con el <span className="bg-clip-text text-transparent bg-linear-to-r from-blue-600 to-purple-500 dark:from-blue-400 dark:to-purple-400">universo.</span>
        </h2>
      ...
      <div className="relative w-full lg:w-1/2 h-26rem sm:h-30rem flex items-center justify-center lg:justify-end overflow-hidden">
        ...
        <div className="relative w-34rem h-34rem md:w-40rem md:h-40rem lg:translate-x-[20%] flex items-center justify-center shrink-0">
          ...
          <div className="w-20 h-20 rounded-full bg-linear-to-br from-yellow-300 via-amber-400 to-orange-500 shadow-[0_0_40px_rgba(245,158,11,0.5)] flex items-center justify-center z-15 border-2 border-white dark:border-zinc-800/80 animate-pulse-slow">
