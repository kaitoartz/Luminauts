...
import { X, Shield, BookOpen, Cookie, Mail, Send, CheckCircle2, FileText, Lock, ShieldCheck, Rocket } from 'lucide-react';
...
export default function LegalInfoModal({ type, isOpen, onClose }) {
  ...
  const getTitleAndIcon = () => {
    switch (type) {
      ...
      default:
        return { title: '', subtitle: '', icon: Shield, color: '', border: '' };
    }
  };
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-[#141923] border border-zinc-800 max-w-3xl w-full rounded-2xl p-6 sm:p-8 relative shadow-2xl overflow-hidden text-left text-white select-text"
        >
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-4 mb-6 relative z-10 border-b border-zinc-800/80 pb-5">
            <div className={`w-10 h-10 rounded-lg ${config.border} border flex items-center justify-center shrink-0`}>
          ...
          <div 
            ...
            className="max-h-[60vh] overflow-y-auto pr-3 space-y-6 text-xs sm:text-sm text-zinc-305 font-medium leading-relaxed custom-scrollbar relative z-10"
          >
            {type === 'privacy' && (
              <div className="space-y-6 text-zinc-300">
                <div className="pb-4 border-b border-zinc-800/50 space-y-2">
                ...
                <div className="space-y-3 pb-4 border-b border-zinc-800/50">
                  <h4 className="font-extrabold text-[#E0B0FF] text-sm flex items-center gap-2">
                    <ShieldCheck size={16} /> 3. Cero Publicidad y Cero Rastreo Comercial
                  </h4>
                  <ul className="list-disc pl-5 space-y-2 text-xs text-zinc-300 leading-relaxed">
                ...
                <div className="pt-4 border-t border-zinc-800/50 space-y-1 text-xs text-zinc-450">
            ...
            {type === 'terms' && (
              <div className="space-y-6 text-zinc-300">
                ...
                <div className="space-y-3 pb-4 border-b border-zinc-800/50">
                  <h4 className="font-extrabold text-[#E0B0FF] text-sm flex items-center gap-2">
                    <Rocket size={16} /> 4. Membresías Estelares y Pases de Fundador
                  </h4>
                  <p className="text-xs text-zinc-305 leading-relaxed">
                ...
                <div className="pt-4 border-t border-zinc-800/50 text-xs text-zinc-450">
            ...
            {type === 'cookies' && (
              <div className="space-y-5 text-zinc-300">
                <p className="text-xs text-zinc-300 leading-relaxed">
                  Utilizamos únicamente almacenamiento local (`localStorage`) y cookies técnicas estrictamente necesarias para el funcionamiento del portal espacial:
                </p>
                ...
                <form onSubmit={handleContactSubmit} className="space-y-5 pt-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#0d111a] border border-zinc-800 text-zinc-100 placeholder-zinc-550 focus:outline-none focus:border-[#8DA9C4] transition-colors"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-[#0d111a] border border-zinc-800 text-zinc-100 placeholder-zinc-550 focus:outline-none focus:border-[#8DA9C4] resize-none transition-colors"
                    />
                  </div>
